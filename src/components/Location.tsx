          ...
          >
            <div className="rounded-2xl sm:rounded-3xl overflow-hidden shadow-2xl h-[300px] sm:h-[400px] lg:h-[700px] relative">
              ...
              <iframe
                ...
                title="숲속의바다 펜션 위치"
              />
              {/* 로딩 중 또는 iframe 실패 시 대체 UI */}
              <div className="absolute inset-0 -z-10 bg-[#1a2332] flex flex-col items-center justify-center p-6">
                <div className="w-16 h-16 rounded-full bg-[#0d1520] flex items-center justify-center mb-4">
                  <MapPin className="w-8 h-8 text-[#4A9F6D]" />
                </div>
                <p className="text-white text-base font-bold mb-2 text-center">지도 로딩 중...</p>
              </div>
            </div>
          </motion.div>
